...
.factory('StratDatapointsExcelService', ['$resource', 'serverEnpoint', function ($resource, serverEndpoint) {
    var address = serverEndpoint + 'api/algodatapointsexcel/:stratname/:cross/?lowerBound=:lowerBound&upperBound=:upperBound';
...
.factory('StratDatapointsTradedExcelService', ['$resource', 'serverEnpoint', function ($resource, serverEndpoint) {
    var address = serverEndpoint + 'api/algodatapointsexcel/:stratname/:cross/traded/?lowerBound=:lowerBound&upperBound=:upperBound';
...
.factory('StratDatapointsLatestExcelService', ['$resource', 'serverEnpoint', function ($resource, serverEndpoint) {
    var address = serverEndpoint + 'api/algodatapointsexcel/:stratname/:cross/latest/';
