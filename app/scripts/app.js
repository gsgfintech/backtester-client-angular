...
angular.module('backtesterclientApp', ['ngAnimate', 'ngclipboard', 'ngCookies', 'ngFileUpload', 'ngResource', 'ngRoute', 'ngSanitize', 'ngTouch', 'SignalR', 'toaster', 'ui.router', 'ui.bootstrap', 'uiSwitch'])
